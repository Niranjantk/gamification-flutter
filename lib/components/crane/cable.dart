...
import 'package:niranjanworld/components/crane/top_piece.dart';
import 'package:niranjanworld/components/player.dart';
import 'package:niranjanworld/components/players/player_factory.dart';
...
class CraneCable extends SpriteComponent {
  ...
  Future<void> onLoad() async {
    ...
    // image = await Flame.images.load('thunder_icon.png');
  }
  ...
  void update(double dt) {
    ...
    if (position.x <= limit.x || position.x >= limit.y) {
      ...
      //     (Vector2.random(rnd) - Vector2.random(rnd)) * 1000;
